...
connection = ms.connect(host='localhost',user='root',password='nitish04',database='atm')
...
welcome_screen.title("  ATM") # setting the title
...
header = Label(text = "WELCOME TO ATM",font = "calibri 20",bg="#fff",fg="#000066",width=80,pady=15) #creating header 
